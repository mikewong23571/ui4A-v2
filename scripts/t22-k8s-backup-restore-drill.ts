    ...
    switch (phase) {
      ...
      case 'create-named-backup':
        return {
          phase,
          executable: 'node',
          args: ['scripts/t22-backup-command.ts', 'backup', '--environment', 'kubernetes'],
        };
      ...
      case 'verify-rpo-rto':
        return {
          phase,
          executable: 'node',
          args: ['scripts/t22-recovery-fingerprint.ts', 'compare', '--drill-id', input.drillId],
        };
    }
  });
}
