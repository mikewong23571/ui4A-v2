...
- [ ] **Track: T38 集合查询治理:合同层分页(无参数全量承诺)+ 声明式过滤 + 实体显示 hint(声明式概览列);agent 浏览器视觉审核 U1–U6,全应用横扫** *Link: [tracks/t38-collection-query-governance_20260829/index.md](./tracks/t38-collection-query-governance_20260829/index.md)*
