...
## Phase B: Chat 正确性、薄协议与 Plane 隔离 [checkpoint: 83ed2de]
...
## Phase D: Application Scenario/Recipe 预生成 [checkpoint: ebe2509]
...
- [x] Task: S5/S6/TS11 Red→Green——Entities layout + repeat/item recipe、实时成员增删、异构诊断和 selection 比较 — 117d58a
...
## Phase G: 用户级 Sidecar、fastpath 与局部失效 [checkpoint: ab4b47e]
