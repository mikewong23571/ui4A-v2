...
const routes: readonly StoryAcceptanceRoute[] = [
  {
    storyId: 'S1',
    deterministic: ['packages/agent/src/t15-story-corpus.test.ts'],
  ...
  {
    storyId: 'S3',
    deterministic: ['packages/agent/src/llm-driver.test.ts'],
    browser: 'e2e/t16-real-llm.spec.ts',
    llmVariants: 4,
  },
  {
  ...
  {
    storyId: 'S6',
    deterministic: ['packages/engine/src/presentation/surface.test.ts'],
    browser: 'e2e/t16-real-llm.spec.ts',
    llmVariants: 4,
  },
  {
  ...
  { storyId: 'S8', deterministic: ['packages/engine/src/presentation/resolver.test.ts'] },
  {
    storyId: 'S9',
    deterministic: ['apps/web/src/engine/presentation/runtime.test.ts'],
    llmVariants: 4,
  },
  { storyId: 'S10', deterministic: ['packages/shared/src/presentation.test.ts'], llmVariants: 4 },
  {
    storyId: 'S11',
    deterministic: ['apps/web/src/render/presentation/compiler.test.ts'],
    llmVariants: 4,
  ...
  { storyId: 'S21', deterministic: ['packages/engine/src/presentation/sidecar.test.ts'] },
  { storyId: 'S22', deterministic: ['packages/engine/src/presentation/sidecar.test.ts'] },
  { storyId: 'S23', deterministic: ['apps/web/src/engine/presentation/broker.test.ts'] },
  {
    storyId: 'S24',
    deterministic: ['packages/agent/src/presentation-revision.test.ts'],
    browser: 'e2e/t16-real-llm.spec.ts',
    llmVariants: 4,
  },
  {
  ...
  { storyId: 'S29', deterministic: ['packages/engine/src/presentation/resolver.test.ts'] },
