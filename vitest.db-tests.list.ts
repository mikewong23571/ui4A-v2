...
export const dbTestFiles: readonly string[] = [
  ...
  'apps/web/src/app/api/meta/exec-governance-expansion.contract.test.ts',
  ...
  'packages/db/src/drafts/drafts-multi-event-accept.test.ts',
  'packages/db/src/drafts/drafts.test.ts',
  ...
  'apps/web/src/engine/drafts/application-bundle-activation.test.ts',
  ...
  'apps/web/src/engine/capability/reconciliation.db.test.ts',
  'apps/web/src/engine/situation-consumers.test.ts',
  'apps/web/src/engine/service-tests/service.application-deprecation.test.ts',
