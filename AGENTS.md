...
- 违反以上任一即架构回退;机制依据见 `DECISIONS.md` D51 与 `conductor/tracks/t34-authority-attention-separation_20260827/architecture.md` §七 执法映射(D50 的 route 级 scopeCoverage 门禁已随该门禁退役)。
